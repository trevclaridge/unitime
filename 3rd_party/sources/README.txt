Content of 3rd_party/sources folder was generated using Maven Dependency Plugin
	...
	mvn dependency:copy-dependencies -Dclassifier=sources -DexcludeScope=provided -DexcludeGroupIds=asm,mysql,org.osgi,org.springframework.ldap,org.springframework.openid,jstl,org.json,antlr -DexcludeArtifactIds=staxmapper -DoutputDirectory=3rd_party/sources
